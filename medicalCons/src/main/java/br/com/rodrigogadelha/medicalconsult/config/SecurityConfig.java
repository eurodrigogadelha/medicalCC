package br.com.rodrigogadelha.medicalconsult.config;
...
public class SecurityConfig {
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.inMemoryAuthentication()
                ...
                .and()
                .withUser("BIBI").password(passwordEncoder.encode("98765")).roles("PACIENTE")
                .and()
                .withUser("KAIO").password(passwordEncoder.encode("121212")).roles("SECRETARIO");
