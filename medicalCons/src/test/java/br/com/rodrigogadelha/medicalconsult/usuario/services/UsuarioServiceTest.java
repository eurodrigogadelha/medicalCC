package br.com.rodrigogadelha.medicalconsult.usuario.services;

import br.com.rodrigogadelha.medicalconsult.usuario.domain.Usuario;
import br.com.rodrigogadelha.medicalconsult.usuario.repositories.UsuarioRepository;
...
class UsuarioServiceTest {
    ...
    void cadastrarUsuario(){
        ...
        assertEquals("Bertin", result.getNomeUsuario());
    ...
    void listarUsuarios(){
        ...
        usuario1.setNomeUsuario("Deixa");
        Usuario usuario2 = new Usuario();
        usuario2.setNomeUsuario("Melevar");
        ...
        assertAll(
                ...
                () -> assertEquals("Manoel", resulta.get(0).getNomeUsuario()),
                () -> assertEquals("Lucas", resulta.get(1).getNomeUsuario())
        );
    }
